...
echo "Starting..."
python -m own_pipeline.create_ensemble --max_seed $MAX_SEED --ensemble_size $ENSEMBLE_SIZE --openml_task_id $TASK_ID --out_dir saved_multi_ensembles --out_dir_subdir_suffix _$MAX_SEED --search_mode $SEARCH_MODE

echo "Evaluating..."
python -m own_pipeline.evaluate_ensemble --openml_task_id $TASK_ID --ensemble_size $ENSEMBLE_SIZE --ensembles_in_dir saved_multi_ensembles --ensembles_in_dir_subdir_suffix _$MAX_SEED --search_mode $SEARCH_MODE
